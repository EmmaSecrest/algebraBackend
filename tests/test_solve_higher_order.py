...
class TestSplitFactorMethod(TestCase):
    def test_factor_common_term(self):
        ...
        self.assertEqual(factor_common_term("x**4 + 2*x**3 + 3*x**2 = 0"),["x(x**2 + 2*x + 3) = 0","For the equation x**2 + 2*x + 3 = 0 : Use quadratic equation with a = 1, b = 2 and c = 3", ["x = 0",'x = -1 - sqrt(2)*I', 'x = -1 + sqrt(2)*I']])
